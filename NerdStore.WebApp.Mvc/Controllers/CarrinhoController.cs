...
using NerdStore.Catologo.Application.Services;
...
public class CarrinhoController : BaseController
{
    ...
    public CarrinhoController(INotificationHandler<DomainNotification> notification,
        IProdutoAppService produtoAppService, IMediatorHandler mediatorHandler, IPedidoQueries pedidoQueries) : base(notification, mediatorHandler)
    {
